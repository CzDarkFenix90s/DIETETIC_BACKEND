...
from dietetic.models import RegistroEjercicio, RutinaEjercicio
...
class RegistroEjercicioSerializer(serializers.ModelSerializer):
    ...
    rutina_ejercicio = serializers.PrimaryKeyRelatedField(
    ...
    class Meta:
        ...
        fields = [
            ...
            'rutina_ejercicio', 'rutina_ejercicio_id', 'rutina_descripcion',
            'fecha', 'completado', 'notas', 'created_at', 'updated_at'
        ]
